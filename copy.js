...
//     description:
//       "Research/Consultancy based role, ongoing over the duration of a few months to create a remote live virtual tour experience for an innovative Israeli Museum.",
//     technologies: [
//       "React",
//       "A-frame",
//       "Twilio",
...
//       "HTML/CSS",
//     ],
//     availability: "https://video.eko.com/v/V1W6bG",
//     images: [
//       {
//         source: "peres-one",
//         contain: "true",
...
//     technologies: ["WordPress", "CSS3", "Google API"],
//     availability: "Available in google play store:",
//     images: [
//       {
//         source: "petwell-two",
//         description:
//           "The vets provided a range of services and as visible here they are described in flip over panels, displayed upon hovering over. The panels flipped with a smooth animation for a good user experience. ",
//       },
//       {
//         source: "petwell-three",
//         description:
//           "The booking an appointment was enabled on the site through using contact forms available via WordPress plugins. Submitting the form sends an email message to the vets using google API’s with all of the relevant information within.",
//       },
//       {
//         source: "petwell-four",
//         description:
//           "The team at Petwell House deserved a proper website to as a testament to the good work they are doing.",
//       },
//     ],
//     publicProject: true,
//   },
...
//     title: "Ma'Pal",
//     description:
//       "Currently in the process of soft-launching a kind of MVP for a platform aimed to help manage project development in a more morally centric/value-driven manner. Part of the theme of this project is to be utilising technology in a more positive manner. ",
//     technologies: [
//       "Node.JS",
//       "HTML/CSS",
//       "React",
...
//       "Digital Ocean",
//     ],
//     availability: "Ssssshh, Coming soon!",
//     images: [
//       {
//         source: "mapal-one",
//         description:
...
//     availability: "Code available @ https://github.com/view4/todolist",
//     images: [
//       {
//         source: "todo-one",
//         description:
//           "Displayed here is an expanded item within the list giving full details of the task which was submitted. The web application was split into two different screens.",
//       },
//       {
//         source: "todo-two",
//         description:
//           "The panel for creating a task has several fields which could optionally be filled, including the linking of values to the task and also a description and specifications panel. ",
//       },
//       {
//         source: "todo-three",
//         description:
//           "A list of the tasks, here you can see that the status of the task is displayed through colour coding. Each of the tasks could also be fully edited too .",
//       },
//     ],
//   },
//   "tv-app": {
...
//     technologies: ["React-Native", "React-Redux", "Javascript"],
//     availability:
//       "Code available @ https://github.com/view4/tvsearch; live app available upon request",
//     images: [
//       {
//         source: "tv-one",
//         description:
//           "The information for the app was retrieved using an API call, and the data was successfully parsed from the JSON to be displayed appropriately for the client. ",
//       },
//       {
//         source: "tv-two",
//         description:
//           "Also included in the app was search capability which communicated with the backend. The data was filtered according to the user input to return the proper information.",
//       },
//       {
//         source: "tv-three",
//         description:
//           "All episodes from each TV series was visible within the app, complete with all information associated with the episode. ",
//       },
//     ],
//   },
//   P4P: {
...
//     technologies: ["VanillaJS", "OOP", "Firebase", "HTML/CSS"],
//     availability: "Available upon requests:",
//     images: [
//       {
//         source: "hob-one",
//         description:
//           "The teachings for each study of the belief is displayed here, organised into three different directions, with relevant teachings split into four different domains - actions, thoughts ...",
//       },
//       {
//         source: "hob-two",
//         description:
//           "The input of the study of the belief is shown here. Entries are stored in a Firebase database.",
//       },
//     ],
//   },
//   fitme: {
...
//         source: "fitmeOne",
//         description:
//           "The website is in place to be launching very soon, so watch this space :)",
//       },
//       {
//         source: "fitmeTwo",
...
copy.projects = {
  ...
  "order-please": {
    title: "Restaurant's order management app (prototype)",
  },
  fleetonomy: {
    title: "Fleetonomy",
  },
...
const heartEmojiHtml =  `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
